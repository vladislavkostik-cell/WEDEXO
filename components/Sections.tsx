...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative z-10 min-h-screen flex items-center py-20 lg:py-0 overflow-hidden border-b border-public-light/20">
      <Container className="w-full">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <Badge className="mb-6 md:mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            Now Accepting New Enterprise Clients
          </Badge>
          
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold font-display text-public-primary tracking-tight leading-tight mb-6 md:mb-8 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
          ...
          <p className="text-base md:text-xl text-public-secondary max-w-2xl mb-8 md:mb-10 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            <span className="text-public-accent-primary font-bold">WEXEDO</span> combines high-end development with data-driven outreach and SEO to build unstoppable growth engines for B2B companies.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300 mb-12 md:mb-16">
            <Button size="lg" href="#book">Get Free Strategy Audit</Button>
